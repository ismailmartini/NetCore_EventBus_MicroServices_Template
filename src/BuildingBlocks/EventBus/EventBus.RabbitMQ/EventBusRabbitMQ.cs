...
namespace EventBus.RabbitMQ
{
    public class EventBusRabbitMQ : BaseEventBus
    {
        ...
        private void SubsManager_OnEventRemoved(object? sender, string eventName)
        {
            ...
            {
                persistentConnection.TryConenct();
            }
        ...
        public override void Publish(IntegrationEvent @event)
        {
            ...
            policy.Execute(() =>
            {
                ...
                //consumerChannel.QueueDeclare(queue: GetSubName(eventName),//ensure queue exists while comsuming
                //                           durable: true,
                //                           exclusive: false,
                //                           autoDelete: false,
                //                           arguments: null);
        ...
        private async void Consumer_Recived (object sender,BasicDeliverEventArgs eventArgs)
        {
