...
namespace OrderService.Infrastructure.Context
{
    public class OrderDbContextSeed
    {
        ...
        private IEnumerable<OrderStatus> GetOrderStatusFromFile(string contentRootPath,ILogger<OrderDbContextSeed> logger)
        {
        ...
        private IEnumerable<CardType> GetCardTypesFromFile(string contentRootPath, ILogger<OrderDbContextSeed> logger)
        {
        ...
        private AsyncRetryPolicy CreatePolicy(ILogger<OrderDbContextSeed> logger, string prefix,int retriest=3)
        {
            return Policy.Handle<SqlException>().
                   WaitAndRetryAsync(
                            ...
                            {
                                logger.LogWarning(exception, "OrderDbContext  insert Exception  with message insert detected ");
